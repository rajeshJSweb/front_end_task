...
const Incomplete = () => {
    ...
    const { data } = useApi();
    const [incompletList, setIncompte] = useState([])
    ...
    useEffect(() => {
        const incompleteData = data.filter((curElem) => curElem.card_parent === "Incomplete");
        setIncompte(incompleteData);
    }, [data]);
